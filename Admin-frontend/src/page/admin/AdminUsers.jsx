    ...
    const fetchUsers = async () => {
      try {
        ...
        const response = await axiosInstance.get(
          `/api/admin/data/users?${params.toString()}`,
        );
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <div className="relative">
            ...
            {showFilterMenu && (
              <div
                ref={filterMenuRef}
                className="absolute right-0 mt-2 w-72 bg-white border border-gray-200 rounded-2xl shadow-xl z-50 p-4"
              >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-6 py-4 bg-gray-50 border-t border-gray-100 text-sm">
            ...
            <div className="flex items-center gap-4 text-gray-600">
              ...
              <span>
                ...
                –<span className="font-medium text-gray-800">{endIndex}</span>{" "}
                of{" "}
                <span className="font-medium text-gray-800">{totalUsers}</span>{" "}
                users
              </span>
            </div>
