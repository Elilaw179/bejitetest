...
const ProfileHeader = ({ onViewMainProfile }) => {
  return (
    <div className="max-w-3xl mx-auto rounded-2xl p-14 bg-[#FFFFFF]">
  ...
  return (
    <div>
      <div className="relative">
        ...
        <span className="absolute w-4 h-4 bg-[#6B8E23] rounded-full border-2 border-white top-18 left-20"></span>
      </div>
      <div className="">
...
const ProfileInfo = ({ onViewMainProfile }) => {
  return (
    <div className="flex flex-col items-center">
      <div>
        <p className="text-[#6B8E23] font-semibold text-[15px]">Osakwe Prisca</p>
        <p className="text-[7px] font-semibold text-[#556B1F]">Jobseeker</p>
      </div>
      <div className="text-center">
        <p className="text-[#556B1F] text-[15px] font-medium">100</p>
        <p className="text-[#556B1F] text-[15px] font-medium">Post</p>
      </div>
      <button
        onClick={onViewMainProfile}
        className="bg-[#556B1F] text-white p-1 w-[140px] rounded-3xl mt-1"
      >
        View Profile
      </button>
    </div>
...
const ConnectionInfo = () => {
  return (
    <div className="flex flex-col items-center mt-8">
      <div className="text-center">
        <p className="text-[#556B1F] text-[15px] font-medium">202</p>
        <p className="text-[#556B1F] text-[15px] font-medium">Connections</p>
      </div>
      <button className="bg-[#556B1F] flex gap-2 justify-center items-center text-white p-1 w-[140px] rounded-3xl mt-1">
...
const ActivitiesSection = () => {
  return (
    <>
      <p className="text-[15px] text-[#6B8E23] font-bold mb-2">Activities</p>
...
const PostAction = ({ icon, text }) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="text-[#1A3E32] text-sm">{text}</p>
    </div>
  );
};
