...
const ProfileHeader = ({ onViewMainProfile }) => {
  return (
    <div className="w-full rounded-2xl p-4 sm:p-10 bg-[#FFFFFF]">
  ...
  return (
    <div className="text-center">
      <div className="relative p-4">
        ...
        <span className="absolute w-4 h-4 bg-[#6B8E23] rounded-full border-2 border-white top-26 left-[70%] transform -translate-x-1/2"></span>
      </div>
      <p className="text-[#6B8E23] font-semibold text-[13px]">Graphics Designer</p>
      <p className="text-[7px] font-semibold text-[#556B1F]">@Lagos, Nigeria</p>
    </div>
...
const ProfileInfo = ({ onViewMainProfile }) => {
  return (
    <div className="flex flex-col items-center p-2 mt-4 sm:mt-6">
      ...
      <div className="text-center mt-2">
        <p className="text-[#556B1F] text-[16px] font-medium">100</p>
        <p className="text-[#556B1F] text-[16px] font-medium">Post</p>
      </div>
      <button
        onClick={onViewMainProfile}
        className="bg-[#556B1F] text-[8px] text-white px-4 py-1 rounded-3xl mt-2"
      >
        View Profile
      </button>
    </div>
...
const ConnectionInfo = () => {
  return (
    <div className="flex flex-col items-center p-2 mt-4 sm:mt-12">
      <div className="text-center">
        <p className="text-[#556B1F] text-[16px] font-medium">202</p>
        <p className="text-[#556B1F] text-[16px] font-medium">Connections</p>
      </div>
      <button className="bg-[#556B1F] flex items-center gap-2 justify-center text-[8px] text-white px-4 py-1 w-[140px] rounded-3xl mt-2">
        <img src="/assets/images/Send_Submit.svg" alt="Send icon" className="w-3 h-3" />
        Message
      </button>
    </div>
...
const ActivitiesSection = () => {
  return (
    <>
      <p className="text-[13px] text-[#6B8E23] font-bold mb-2 mt-4">Activities</p>
      <div className="w-full rounded-2xl p-4 shadow-2xl bg-white">
        <div className="flex flex-wrap gap-4 justify-center text-[13px]">
          <ActivityButton text="Posts" />
          <ActivityButton text="Photos" />
          <ActivityButton text="Videos" />
        </div>
      </div>
      <div className="w-full my-8 border-t border-[#16730F]" />
    </>
  );
};
...
const ActivityButton = ({ text }) => {
  return (
    <button className="text-[#FFFFFF] bg-[#556B1F] py-1 px-4 w-28 rounded-2xl">
      {text}
    </button>
  );
};
...
const PostCard = () => {
  return (
    <div className="bg-white p-4 sm:p-6 w-full rounded-2xl space-y-6">
      <PostHeader />
      <PostContent />
      <PostImage />
      <PostActions />
