  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#16730F] via-[#16730F] to-[#122b23] rounded-3xl p-8 sm:p-12 text-center shadow-md">
      ...
      <div className="relative z-10 space-y-4">
        <span className="px-3.5 py-1 bg-[#F5F5F5] text-[#1A3E32] rounded-full text-xs font-bold tracking-wider uppercase border border-emerald-500/30">
        ...
        <p className="text-[#fff]/50 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
