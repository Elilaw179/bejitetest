...
export default function EditPipelineStageModal({ isOpen, onClose, stage, onUpdateStage }) {
  ...
  useEffect(() => {
    if (stage) {
      ...
      setDescription(stage.description || "Describe interview focus, evaluation rubric, or candidate expectations...");
        ...
        <div className="flex items-center gap-3.5 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-normal mt-0.5">
              Set up a new recruitment exercise to begin inviting qualified candidates.
            </p>
          </div>
        </div>
