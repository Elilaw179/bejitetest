        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-white border border-gray-300 text-gray-800 text-sm p-4 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#16730F]/40 font-medium resize-none disabled:opacity-60"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4 border-t border-gray-100">
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className="bg-[#E5E7EB] w-full hover:bg-gray-300 text-gray-800 font-bold px-6 py-2.5 rounded-full text-sm transition-colors active:scale-95 disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="bg-[#16730F] w-full hover:bg-[#125B0C] text-white font-bold px-6 py-2.5 rounded-full text-sm transition-colors shadow-md active:scale-95 disabled:opacity-60"
            >
