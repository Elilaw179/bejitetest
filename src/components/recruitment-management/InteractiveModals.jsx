    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl max-w-md w-full max-h-[90vh] overflow-y-auto nfl-scroll p-6 shadow-2xl relative border border-gray-100 animate-in zoom-in-95 duration-200">
        <button
          type="button"
          onClick={onClose}
          className="absolute right-4 top-4 text-gray-400 hover:text-gray-600 bg-gray-100 p-2 rounded-full"
        >
          <FaTimes />
        </button>
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-[#E6F4EA] text-[#16730F] flex items-center justify-center text-lg">
            <FaLayerGroup />
          </div>
          <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="bg-[#E5E7EB] hover:bg-gray-300 text-gray-800 font-bold px-5 py-2 rounded-full text-xs"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="bg-[#16730F] hover:bg-[#125B0C] text-white font-bold px-5 py-2 rounded-full text-xs shadow-xs"
            >
              Add Stage
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="bg-[#E5E7EB] text-gray-800 font-bold px-5 py-2 rounded-full text-xs"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="bg-[#B45309] hover:bg-[#92400E] text-white font-bold px-5 py-2 rounded-full text-xs shadow-xs"
            >
              Save Feedback
            </button>
          </div>
