        ...
        <div className="text-center mt-10 mb-10">
          {!agreed ? (
            <>
              ...
              <p className="text-sm text-center text-[#16730F] px-4">
                Okpata favour has invited you for an interview as a Graphics Designer on July 20th, 9:00am. 
                Please respond within 72 hours. If no response, this invite will be automatically declined.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-xl font-semibold text-center text-[#16730F] mb-2">
                You have accepted the interview invite.
              </p>
              <p className="text-sm text-center text-[#16730F]">
