      ...
      <div className="max-w-7xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatCard 
            ...
            value={metrics?.latest?.total_ase_searches || metrics?.funnel?.total_applications || 0}
            icon={Users}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-xs text-gray-500 -mt-4 mb-4">Top 10 jobs with the most searches by Recruiters using the ASE</p>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-xs text-gray-500 -mt-4 mb-4">Recruiter usage of Advanced Search (ASE)</p>
             <div className="h-64 w-full">
         ...
         <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
           <h3 className="text-lg font-bold text-gray-800 mb-6">Top Sectors Searched by Recruiters (ASE)</h3>
           <p className="text-xs text-gray-500 -mt-4 mb-4">Top 10 sectors most searched for by recruiters using the ASE</p>
           <div className="h-80 w-full">
             {sectorTrendData.length > 0 ? (
               <ResponsiveContainer width="100%" height="100%">
                 <BarChart data={sectorTrendData} layout="vertical" margin={{ top: 0, right: 0, left: 60, bottom: 0 }}>
                   <CartesianGrid strokeDasharray="3 3" horizontal={true} vertical={false} stroke="#f0f0f0" />
                   <XAxis type="number" hide />
                   <YAxis 
                     type="category" 
                   ...
                   <RechartsTooltip 
                     ...
                     contentStyle={{borderRadius: '8px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)'}}
                   />
                   <Bar dataKey="search_count" name="Searches" fill="#8b5cf6" radius={[0, 4, 4, 0]} barSize={18} />
                 </BarChart>
               </ResponsiveContainer>
             ) : (
               <div className="h-full flex items-center justify-center text-gray-400">No sector search data available</div>
             )}
           </div>
         </div>
